...
var _class = function (_React$Component) {
  ...
  _createClass(_class, [{
    ...
    value: function componentWillMount() {
      ...
      var expiration = Date.now() + 3600000 * 48;
      setInterval(function () {
        var e = expiration - Date.now();
        var hours = Math.floor(e / 3600000).toFixed(0);
        var minutes = Math.floor(e % 3600000 / 60000).toFixed(0);
        var seconds = Math.floor(e % 60000 / 1000).toFixed(0);
        _this2.setState({
...
var styleSheet = new StyleSheet({ speedy: false });
...
var styleSheet$1 = new StyleSheet({ speedy: false, maxLength: 40 });
...
var _TimeRemaining = __webpack_require__(1);
...
var Child = _styledComponents2.default.div(_templateObject4);

var Center = _styledComponents2.default.div(_templateObject2);

var Progress = _styledComponents2.default.div(_templateObject5);

var ProgressBar = _styledComponents2.default.div(_templateObject6, function (p) {
  return p.percent;
});
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'Progress: ',
          Math.ceil(100 * (state.index / length)),
          '%',
          _react2.default.createElement(_TimeRemaining2.default, null)
        )
      )
    )
  );
